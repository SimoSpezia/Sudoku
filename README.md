...
**Come Giocare**
    ...
    Movimento: Usa le Frecce Direzionali per spostare il cursore (evidenziato in giallo).
    Inserimento: Digita i numeri da 1 a 9 per riempire le caselle verdi.
    Cancellazione: Digita 0 per svuotare una cella inserita.
    Controllo Manuale: Premi C per verificare se la configurazione attuale contiene errori.
    Uscita: Premi E per tornare al menu principale.
